...
export const HAND_CHOICES: HandChoice[] = ['rock', 'paper', 'scissors'];

export function calculateJankenOutcome(playerChoice: HandChoice, opponentChoice: HandChoice): Outcome {
...
export function getOpponentChoice(): HandChoice {
...
export function playRound(playerData: PlayerData, playerChoice: HandChoice): {
