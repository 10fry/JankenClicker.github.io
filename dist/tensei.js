...
export function calculateTenseiTokens(playerData) {
    ...
    if (playerData.jankenSpirit < 5000 && playerData.stats.totalWins < 100)
        return 0;
    return Math.max(0, spiritContribution + winsContribution);
}
export function performTensei(playerData) {
